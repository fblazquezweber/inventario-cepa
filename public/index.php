...
<html lang="es">
  <head>
    ...
    <title>Login - Inventario CEPA</title>
  ...
  <body class="bg-light d-flex align-items-center justify-content-center vh-100">
    ...
    <div class="card shadow-sm p-4" style="width: 100%; max-width: 380px;">
      ...
      <div class="text-center mb-3">
        <img src="assets/img/logo-cepa.png" alt="Logo CEPA" style="width: 160px;">
        <h5 class="mt-3">Sistema de Inventario CEPA</h5>
      </div>

      <?php if ($mensaje_error): ?>
  <div class="alert alert-danger position-relative p-2 px-3 mb-3 small" role="alert">
    <span>
...
<?php endif; ?>
      ...
      <div class="text-center mt-3 small text-muted">
        <a href="recuperar.php">¿Olvidó su contraseña?</a><br>
        v1.0 · © 2025 · Área Tecnología
      </div>
    </div>

    <script src="assets/js/custom/clearLoginFields.js"></script>
