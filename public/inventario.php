...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['guardar'])) {
    ...
    // Si cambia a Mantenimiento o Baja, mostrar sección de movimientos
    if (in_array($datos['estado'], ['Mantenimiento', 'Baja'])) {
        $mostrarMovimiento = true;
    }
}
?>
<!DOCTYPE html>
...
document.getElementById('estadoSelect').addEventListener('change', function() {
  ...
  sec.style.display = ['Mantenimiento','Baja'].includes(this.value) ? 'block' : 'none';
});
</script>
